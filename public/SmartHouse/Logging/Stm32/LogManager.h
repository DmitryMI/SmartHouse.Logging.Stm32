...
namespace SmartHouse::Logging::Stm32
{
	...
	template<typename TLogSink, typename TTimestampProvider, typename TDebuggerDetector = DummyDebuggerDetector<true>, LogLevel::Level TMinLevel = LogLevel::Level::Info>
	class LogManager
	{
	public:
